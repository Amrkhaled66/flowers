...
const PasswordInput = ({
  ...
  return (
    <div className="flex flex-col gap-y-3">
      <label className="text-start font-bold" htmlFor={name}>
        {label}
      </label>
  ...
  #616161"
        ...
        <input
          ...
          onChange={onChange}
          value={value}
          className={`"placeholder:text-subTitle border-stroke animate focus:border-main h-full w-full rounded-xl border py-2.5 
            ${notShowingIcon ? "ps-3" : "ps-10"}
            `}
