  ...
  return (
    <div className="block lg:hidden">
      ...
      <div
        ...
        //   exit={{ translateX: "100%" }}
        className={`text-text-main fixed end-0 top-0 z-[1000] space-y-5 lg:hidden ${open ? "end-0" : "end-[-150%]"} animate h-screen w-full rounded-xl bg-white p-4 drop-shadow-xl`}
      >
