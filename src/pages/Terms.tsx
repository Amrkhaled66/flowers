    ...
    <div className="mx-auto max-w-4xl space-y-6 px-4 py-10 text-gray-800">
      {isArabic ? (
        <>
          ...
          <p>
            مرحبًا بك في Ballora، متجر الهدايا والبالونات المصمّمة بشكل باقات
            ورد. يرجى قراءة الشروط والأحكام بعناية قبل استخدام خدماتنا.
          </p>

          <h2 className="text-xl font-semibold">1. الموافقة على الشروط</h2>
          <p>
            باستخدامك موقعنا أو تطبيقنا، فإنك توافق تلقائيًا على جميع الشروط
            والأحكام الموضّحة أدناه.
          </p>
          ...
          <h2 className="text-xl font-semibold">
            6. المنتجات المصممة حسب الطلب
          </h2>
          <p>
            قد تختلف الألوان أو الترتيب قليلًا حسب توفر المواد. الصور لأغراض
            توضيحية فقط.
          </p>

          <h2 className="text-xl font-semibold">7. الأسعار والدفع</h2>
          <p>
            الأسعار تشمل كل شيء، ويتم الدفع عبر بوابات آمنة. الطلب لا يُعتبر
            مؤكدًا إلا بعد الدفع الكامل.
          </p>

          <h2 className="text-xl font-semibold">8. الاسترجاع والاستبدال</h2>
          <p>
            لا استرجاع للمنتجات المصممة خصيصًا. الاستبدال خلال 24 ساعة من
            الاستلام مع تقديم صور للمنتج المتضرر.
          </p>
          ...
          <p>
            جميع المحتويات ملك لـ Ballora ويُمنع النسخ أو الاستخدام دون إذن.
          </p>

          <h2 className="text-xl font-semibold">
            11. منتجات العطور والشوكولاتة والكيك
          </h2>
          <p>
            نقدم منتجات إضافية من شركاء موثوقين. المسؤولية على المورد. يرجى
            التواصل خلال 24 ساعة في حال وجود ملاحظات.
          </p>

          <h2 className="text-xl font-semibold">12. التعديلات على الشروط</h2>
          <p>
            نحتفظ بالحق في تعديل الشروط، وسيتم إشعار العملاء عبر البريد أو
            الإشعارات.
          </p>
        ...
        <>
          <h1 className="text-2xl font-bold">
            📜 Terms & Conditions – Ballora
          </h1>
          <p>Last Updated: 8-7-2025</p>

          <p>
            Welcome to Ballora, the gift and balloon store specializing in
            floral-inspired balloon arrangements. Please read these terms and
            conditions carefully before using our services.
          </p>

          <h2 className="text-xl font-semibold">1. Acceptance of Terms</h2>
          <p>
            By using our website or app, you automatically agree to all the
          ...
          <ul className="list-disc pl-6">
            ...
            <li>
              Errors on our part will be resolved via redelivery or refund
            </li>
          </ul>
          ...
          <p>
            Prices include all components. Secure payment required for
            confirmation.
          </p>

          <h2 className="text-xl font-semibold">8. Returns and Replacements</h2>
          <p>
            No returns for custom products. Replacements within 24 hours of
            delivery with photo proof.
          </p>

          <h2 className="text-xl font-semibold">9. Prohibited Use</h2>
          <p>
            Illegal use is prohibited. We reserve the right to ban violators.
          </p>

          <h2 className="text-xl font-semibold">10. Intellectual Property</h2>
          <p>
            All content is owned by Ballora. No use or copying without written
            permission.
          </p>

          <h2 className="text-xl font-semibold">
            11. Perfume, Chocolate & Cake (Third-Party Partnerships)
          </h2>
          <p>
            Offered via trusted partners. Quality and responsibility lie with
            the suppliers. Report issues within 24 hours.
          </p>

          <h2 className="text-xl font-semibold">12. Amendments to Terms</h2>
          <p>
            We may update these terms and notify customers via email or in-app
            notice.
          </p>
