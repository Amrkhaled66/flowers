const shippingStatusTextColor = {
  orderPlaced: "text-blue-600",
...
const APPONAPPSTORE = "https://apps.apple.com/us/app/ballora";

export {
  shippingStatusTextColor,
  FREEDELIVERYBRECKDOWN,
  ENDDEDDELIVERYHOUR,
  APPONGOOGLEPLAY,
  APPONAPPSTORE,
};
